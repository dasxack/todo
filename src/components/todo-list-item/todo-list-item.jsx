...
const TodoListItem = ({
  ...
  return (
    <>
      <div hidden={(done && curFilter === 'Active') || (!done && curFilter === 'Completed')}>
        {editer ? (
          <form onSubmit={onSubmitInput}>
            <input type="text" className="edit" value={labelInp} onChange={changeValue} />
          </form>
        ) : (
          <div className="view">
            <input className="toggle" type="checkbox" id={idFor} onClick={onToggleDone} defaultChecked={done} />
            <label htmlFor={idFor}>
            ...
            <button className="icon icon-edit" onClick={toggleEditer}></button>
